 classdef breathmetrics_modif < matlab.mixin.Copyable
    % Version 2.0 9/30/2019 MODIFIED BY USER!
    %
    % Created by The Zelano Lab
    % Modified by Catherine Bratschi (LGC - EPFL)
    %
    ...
    methods
        %%% constructor %%%
        function Bm = breathmetrics_modif(resp, srate, dataType)
            ...
            Bm.smoothedRespiration = ...
                fftSmooth_modif(resp, srateCorrectedSmoothedWindow)';
        ...
        function Bm = correctRespirationToBaseline(Bm, method, ...
            ...
            interpSmoothData = Bm.smoothedRespiration;
            thisResp = detrend(interpSmoothData, 'omitnan');
            
            %find mean resp
            respMean = thisResp - mean(thisResp,'omitnan');
            ...
            elseif strcmp(method, 'sliding')
                ...
                respSlidingMean=fftSmooth_modif(thisResp, srateCorrectedSW);

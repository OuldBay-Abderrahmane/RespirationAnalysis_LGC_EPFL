function y = fftSmooth_modif(resp,srateCorrectedSmoothedWindow, srate)

% create the window
L      = length(resp);
window = zeros(1,L);
if L < srateCorrectedSmoothedWindow
    srateCorrectedSmoothedWindow = L;
else 
    srateCorrectedSmoothedWindow = srateCorrectedSmoothedWindow;
end

function QRS = run_qrsdet_by_seg_modif(ecg,HRVparams)
...
%     % modif 221230_data length was smaller than what was required by the
%     % qrs calculation
%     if segsizeSampe > length(ecg)
%         segsizeSampe = length(ecg);
%     end

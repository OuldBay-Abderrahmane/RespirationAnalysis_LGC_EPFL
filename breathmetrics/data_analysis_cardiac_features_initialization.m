function HRVparams = data_analysis_cardiac_features_initialization(project_name)
%
...
switch project_name   
    ...
    case 'VIBES_study1'                   % Update with your project name
        HRVparams.Fs = 1000;                % Spacify sampling frequency
...
HRVparams.windowlength = 60*2.5;	      % Default: 300, seconds
...
HRVparams.RejectionThreshold = .80;   % Default: 0.2, amount (%) of data that can be rejected before a
...
HRVparams.sqi.LowQualityThreshold = 0.30; % Default: 0.9, Threshold for which SQI represents good data
...
HRVparams.sd.segmentlength = 60*2.5;           % Default: 300, windows length in seconds
